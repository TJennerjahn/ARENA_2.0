...
def rearrange_1() -> t.Tensor:
    ...
    temp = t.arange(3, 9)
    print(temp)
    temp = rearrange(temp, "(a b) -> a b", a=3, b=2)
    print(temp)
    return temp
...
def rearrange_2() -> t.Tensor:
    ...
    [[1, 2, 3],
     [4, 5, 6]]
    """
    return rearrange(t.arange(1, 7), "(a b) -> a b", a=2, b=3)
...
def rearrange_3() -> t.Tensor:
    ...
    [[[1], [2], [3], [4], [5], [6]]]
    """
    temp = rearrange(t.arange(1, 7), "(a b c) -> a b c", a=1, c=1)
    print(temp)
    return temp
...
def temperatures_average(temps: t.Tensor) -> t.Tensor:
    ...
    result = reduce(temps, '(a b) -> a', 'mean', b=7)
    # print(result)
    return result
...
def temperatures_differences(temps: t.Tensor) -> t.Tensor:
    ...
    # print(avg_temps)
    result = temps - repeat(avg_temps, 'a -> (a 7)')
    # print(result)
    return result
...
def temperatures_normalized(temps: t.Tensor) -> t.Tensor:
    ...
    # print(avg)
    # print(reduce(temps, "(h 7) -> h", t.std))
